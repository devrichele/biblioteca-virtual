...
export default function BibliotecaForm() {
  ...
  const handleGenreChange = (genre: string, checked: boolean) => {
    setFormData((prev) => ({
      ...prev,
      generosFavoritos: checked ? [...prev.generosFavoritos, genre] : prev.generosFavoritos.filter((g) => g !== genre),
    }))
  }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("https://n8n.flory.dev/webhook/8a7c32ac-049d-4ba3-8321-a8f30bb45060", {
        method: "POST",
        headers: {
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    <Label className="text-gray-700 font-medium">Idioma Preferido</Label>
                    <Select
                ...
                <div>
                  ...
                  <RadioGroup
                    ...
                    onValueChange={(value) => setFormData((prev) => ({ ...prev, frequenciaLeitura: value }))}
              ...
              <div className="space-y-4">
                ...
                <div>
                  <Label htmlFor="autoresFavoritos" className="text-gray-700 font-medium">
                    Autores Favoritos
                  </Label>
                  <Input
                    id="autoresFavoritos"
              ...
              {submitStatus === "error" && (
                <div className="bg-red-50 border border-red-200 rounded-lg p-4 text-center">
                  <p className="text-red-800 font-medium">✗ Erro ao processar cadastro.</p>
                </div>
              )}
            </form>
          </CardContent>
                    ...
                    <Card key={index} className="border-l-4 border-l-amber-500">
                      <CardContent className="p-6">
                        <div className="space-y-3">
                          ...
                          <div>
                            <h4 className="font-semibold text-gray-700 mb-1">Por que recomendamos:</h4>
                            <p className="text-gray-600 text-sm leading-relaxed">{book.motivo}</p>
                          </div>

                          {book.ondeEncontrar && (
                            <div>
                              <h4 className="font-semibold text-gray-700 mb-1">Onde encontrar:</h4>
                              <p className="text-gray-600 text-sm">{book.ondeEncontrar}</p>
                            </div>
                          )}
                        </div>
                      </CardContent>
